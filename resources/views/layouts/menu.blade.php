...
<li class="nav-item has-treeview {{ Request::is('appointments*') || Request::is('appointmentStatuses*') || Request::is('deliveryAddresses*')? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('appointments*') || Request::is('appointmentStatuses*') || Request::is('deliveryAddresses*')? 'active' : '' }}"> @if($icons)<i class="nav-icon fas fa-calendar-check"></i>@endif
        <p>{{trans('lang.appointment_plural')}} <i class="right fas fa-angle-left"></i></p>
    </a>
    <ul class="nav nav-treeview">
